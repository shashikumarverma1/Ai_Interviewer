  ...
  useEffect(() => {
    fetch("/api/question")
      ...
      .then((data) => {
        ...
        setQuestion(JSON.parse(data.name))
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="bg-indigo-600 px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-indigo-100">Software Engineer Position</span>
            </div>
          </div>
          ...
          <div className="px-6 py-8 border-b border-gray-200">
            ...
            <p className="mt-2 text-gray-600">{currentQuestionIndex + 1}.  {questions[currentQuestionIndex]?.question}</p>
          </div>
