export default function FeedbackCard({ data, index }: { data: any, index: number }) {
   
    function fixObjectReferences(str:any, data:any) {
        ...
        <div className="flex justify-center items-center  bg-gray-100 p-4 min-h-[calc(100vh-4rem)] bg-gray-50 py-8">
            <div className=" w-full bg-white shadow-lg rounded-2xl p-6">
                ...
                <div className="mb-4">
                    ...
                    <p className="text-gray-600">{fixObjectReferences(data.feedback , data)}</p>
                </div>
                <div className="mb-4">
                    <h3 className="text-lg font-semibold text-gray-800">Improvement Suggestion</h3>
                    <p className="text-gray-600">{fixObjectReferences(data.improvement , data)}</p>
                </div>
                <div>
